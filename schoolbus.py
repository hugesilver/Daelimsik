...
for anyang_to_school in anyang_tr:
    if ((anyang_to_school.select_one('td:nth-child(1)').get_text()) == " ") or ((anyang_to_school.select_one('td:nth-child(1)').get_text()) == "") or ((anyang_to_school.select_one('td:nth-child(1)').get_text()) == "휴게시간"):
        pass
    elif (((anyang_to_school.select_one('td:nth-child(1)').get_text())[1].isdigit() == False) and (((anyang_to_school.select_one('td:nth-child(2)').get_text()) == "") or (anyang_to_school.select_one('td:nth-child(2)').get_text()) == " ")):
        pass
        ...
        if (anyang_to_school.select_one('td:nth-child(3)').get_text() == "해당시간") or (anyang_to_school.select_one('td:nth-child(3)').get_text() == "") or (anyang_to_school.select_one('td:nth-child(3)').get_text() == " "):
            m_460_anyang_to_school.write("\\n")
        else:
        ...
        if (anyang_to_school.select_one('td:nth-child(2)').get_text()) == "":
            pass
        else:
            m_460_anyang_to_school.write("- ")
            m_460_anyang_to_school.write(anyang_to_school.select_one('td:nth-child(2)').get_text() + " ")
            if (anyang_to_school.select_one('td:nth-child(4)').get_text() == "해당시간") or (anyang_to_school.select_one('td:nth-child(4)').get_text() == "") or (anyang_to_school.select_one('td:nth-child(3)').get_text() == " "):
                m_460_anyang_to_school.write("\\n")
            else:
...
for school_to_anyang in anyang_tr:
    if ((school_to_anyang.select_one('td:nth-child(1)').get_text()) == "휴게시간"):
        ...
        if (school_to_anyang.select_one('td:nth-child(3)').get_text() == "해당시간") or (school_to_anyang.select_one('td:nth-child(3)').get_text() == "") or (school_to_anyang.select_one('td:nth-child(3)').get_text() == " "):
            m_460_school_to_anyang.write("\\n")
        else:
        ...
        if (school_to_anyang.select_one('td:nth-child(4)').get_text() == "해당시간") or (school_to_anyang.select_one('td:nth-child(4)').get_text() == "") or (school_to_anyang.select_one('td:nth-child(3)').get_text() == " "):
            m_460_school_to_anyang.write("\\n")
        else:
...
for beomgye_to_school in beomgye_tr:
    if ((beomgye_to_school.select_one('td:nth-child(1)').get_text()) == " ") or ((beomgye_to_school.select_one('td:nth-child(1)').get_text()) == "") or ((beomgye_to_school.select_one('td:nth-child(1)').get_text()) == "휴게시간"):
        pass
    elif (((beomgye_to_school.select_one('td:nth-child(1)').get_text())[1].isdigit() == False) and (((beomgye_to_school.select_one('td:nth-child(2)').get_text()) == "") or (beomgye_to_school.select_one('td:nth-child(2)').get_text()) == " ")):
        pass
        ...
        if (beomgye_to_school.select_one('td:nth-child(3)').get_text() == "해당시간") or (beomgye_to_school.select_one('td:nth-child(3)').get_text() == "") or (beomgye_to_school.select_one('td:nth-child(3)').get_text() == " "):
            m_460_beomgye_to_school.write("\\n")
        else:
        ...
        if (beomgye_to_school.select_one('td:nth-child(2)').get_text()) == "":
            pass
        else:
            m_460_beomgye_to_school.write("- ")
            m_460_beomgye_to_school.write(beomgye_to_school.select_one('td:nth-child(2)').get_text() + " ")
            if (beomgye_to_school.select_one('td:nth-child(4)').get_text() == "해당시간") or (beomgye_to_school.select_one('td:nth-child(4)').get_text() == "") or (beomgye_to_school.select_one('td:nth-child(3)').get_text() == " "):
                m_460_beomgye_to_school.write("\\n")
            else:
...
for school_to_beomgye in beomgye_tr:
    if ((school_to_beomgye.select_one('td:nth-child(1)').get_text()) == "휴게시간"):
        pass
    elif (school_to_beomgye.select_one('td:nth-child(1)').get_text() == " ") or  (school_to_beomgye.select_one('td:nth-child(1)').get_text() == "") or ((school_to_beomgye.select_one('td:nth-child(1)').get_text())[1].isdigit() == True):
        m_460_school_to_beomgye.write("- ")
        m_460_school_to_beomgye.write(school_to_beomgye.select_one('td:nth-child(2)').get_text() + " ")
        if (school_to_beomgye.select_one('td:nth-child(3)').get_text() == "해당시간") or (school_to_beomgye.select_one('td:nth-child(3)').get_text() == "") or (school_to_beomgye.select_one('td:nth-child(3)').get_text() == " "):
            m_460_school_to_beomgye.write("\\n")
        else:
        ...
        if (school_to_beomgye.select_one('td:nth-child(4)').get_text() == "해당시간") or (school_to_beomgye.select_one('td:nth-child(4)').get_text() == "") or (school_to_beomgye.select_one('td:nth-child(3)').get_text() == " "):
            m_460_school_to_beomgye.write("\\n")
        else:
